	...
	public void t1(String[] args) {
		...
		try {
			...
			try {
                ...
                adapter = communicator.createObjectAdapterWithEndpoints("Adapter2", "tcp -h 127.0.0.1 -p 10000 -z : udp -h 127.0.0.1 -p 10000 -z");
            }

			// 3. Utworzenie serwanta/serwantów
            // CalcI sharedServant = new CalcI(); // To jest nasz wspólny serwant
            CalcI servantForCalc11 = new CalcI();
            CalcI servantForCalc33 = new CalcI();

            // 4. Skojarzenie wielu identyfikatorów z TYM SAMYM serwantem
//            adapter.add(sharedServant, new Identity("calc11", "calc"));
//            adapter.add(sharedServant, new Identity("calc33", "calc"));
            adapter.add(servantForCalc11, new Identity("calc11", "calc"));
            adapter.add(servantForCalc33, new Identity("calc33", "calc"));
